...
import { researchAreas, codeAndData, type Paper, type ResearchArea } from "@/data/researchAreas"
...
function ResearchAreaSection({ area, index }: ResearchAreaSectionProps) {
  // Sort papers by year from newest to oldest
  ...
  return (
    <section className={cn("py-12 md:py-16", index % 2 === 0 ? "section-white" : "section-gray")}>
      <Container>
        ...
        {/* Two-column layout: Timeline navigation + Paper cards */}
        <Reveal delayMs={100}>
            ...
            <CardContent className="p-4 sm:p-5">
              <div className="flex min-w-0 flex-col gap-3 lg:flex-row lg:gap-5">
                ...
                <nav className="shrink-0 lg:w-56 lg:border-r lg:border-border/40 lg:pr-4">
                  ...
                  <div
                    className="-mx-1 flex gap-1.5 overflow-x-auto px-2 py-1 lg:hidden"
                  >
...
function PaperCard({ paper, isActive }: { paper: Paper; isActive: boolean }) {
  ...
  return (
    ...
    >
      {/* Images row - displayed above content if multiple, or inline if single */}
...
export default function ContributePage() {
  return (
    <div className="bg-background">
      ...
      {/* Research Areas - displayed individually */}
